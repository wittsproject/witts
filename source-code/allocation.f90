...
!-----------------------------------------------------------------!
    ...
    ALLOCATE(S11(NX1:NX2,NY1:NY2,NZ1:NZ2),S22(NX1:NX2,NY1:NY2,NZ1:NZ2), &
             S33(NX1:NX2,NY1:NY2,NZ1:NZ2),S12(NX1:NX2,NY1:NY2,NZ1:NZ2), &
             S13(NX1:NX2,NY1:NY2,NZ1:NZ2),S23(NX1:NX2,NY1:NY2,NZ1:NZ2))
    ALLOCATE(S(NX1:NX2,NY1:NY2,NZ1:NZ2))
    ALLOCATE(S12C(NX1:NX2,NY1:NY2,NZ1:NZ2),S13C(NX1:NX2,NY1:NY2,NZ1:NZ2), &
             S23C(NX1:NX2,NY1:NY2,NZ1:NZ2))
    ...
    IF(ITEMP.EQ.1)THEN
      ALLOCATE(Q1(NX1:NX2,NY1:NY2,NZ1:NZ2),Q2(NX1:NX2,NY1:NY2,NZ1:NZ2), &
               Q3(NX1:NX2,NY1:NY2,NZ1:NZ2))
      Q1=0.0
      Q2=0.0
      Q3=0.0
    END IF
    ...
    IF(IINFLOW_READ.EQ.1)THEN
      ALLOCATE(INDATA0(INF_NXT,INF_NYT,INF_NZT,INF_NUM_VAR), &
